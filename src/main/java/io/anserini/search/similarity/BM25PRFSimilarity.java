 ...
 */
public class BM25PRFSimilarity extends Similarity {
    ...
    private class BM25DocScorer extends SimScorer {
        ...
        BM25DocScorer(Stats stats, int indexCreatedVersionMajor, NumericDocValues norms) throws IOException {
            this.stats = stats;
    ...
    private static class Stats extends SimWeight {
        /** BM25's idf */
     ...
     * @see #BM25PRFSimilarity(float, float)
     */
